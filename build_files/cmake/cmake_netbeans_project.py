...
def create_nb_project_main():
    ...
    if not SIMPLE_PROJECTFILE:
        ...
        PROJECT_NAME = "Blender" if 0 else project_name_get()
        ...
        with open(join(PROJECT_DIR_NB, "project.xml"), 'w') as f:
        ...
        with open(join(PROJECT_DIR_NB, "configurations.xml"), 'w') as f:
            f.write('<?xml version="1.0" encoding="UTF-8"?>\n')
